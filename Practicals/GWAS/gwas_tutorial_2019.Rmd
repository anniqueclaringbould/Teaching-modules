...
**Q3**: What is the MAF of the first SNP? What about the fourth SNP? Which SNP is more frequent?
...
<br>
Make two histograms of the minor allele frequencies: one with and one without the filtered SNPs, to see if everything is correct before and after filtering. Use the `hist()` function to plot `minor_allele_frequency_per_snp`.
```{r, message=FALSE, warning=FALSE, eval=FALSE, echo=FALSE}
...
**Q7**: How many SNPs do not deviate from HWE?
```{r, message=FALSE, warning=FALSE, eval=FALSE, echo=FALSE}
